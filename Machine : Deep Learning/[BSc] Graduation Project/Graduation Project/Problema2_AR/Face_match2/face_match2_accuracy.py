...
##################################################################################################################################################################################################################################################################################################################################################################################################
if(os.path.exists("face_match2_ranking.txt")): os.remove("face_match2_ranking.txt")
if(os.path.exists("face_match2_top.txt")): os.remove("face_match2_top.txt")
...
for i in bd:
    ...
    subprocess.run(["python3","face_match2.py",i])

posicoes = []
posicoes_contagem = []
posicoes_media = []
sem_partilha = []
with open("face_match2_ranking.txt","r") as ficheiro:
