...
if(diferentes>1):
    for i in diretoria:
        ...
        if(("X" not in i) and i[0]!="."):
            print("ERRADAS - VALIDACAO - AFASTA (" + str(aux) + "/" + str(num_seq) + ")")
            aux += 1

            if(not os.path.exists("grupos_interpolados/validacao/afasta/" + i + "X")): os.makedirs("grupos_interpolados/validacao/afasta/" + i + "X")

            ficheiro = open("grupos_interpolados/validacao/afasta/" + i + "X/1escolha.txt","w")
            ...
            if(int(escolha*tamanho)>=tamanho):
                melhor = melhor_individuo(((dir_original[tamanho-1]).split(".")[0]).split(")")[1],"grupos_interpolados/validacao/afasta/",i)
            
            else:
                melhor = melhor_individuo(((dir_original[int(escolha*tamanho)]).split(".")[0]).split(")")[1],"grupos_interpolados/validacao/afasta/",i)

            # erro ao tentar obter o melhor indivíduo para trocar patches
            if(melhor[0]=="ERRO"):
                rmtree("grupos_interpolados/validacao/afasta/" + i + "X")
                continue
            ...
            for count in range(0,num_erradas,1):
                ...
                if(int(escolha*tamanho)>=tamanho):
                    atual = patches(escolhidas, ((dir_original[tamanho-1]).split(".")[0]).split(")")[1], melhor[0], "grupos_interpolados/validacao/afasta/" + i)
                
                else:
                    atual = patches(escolhidas, ((dir_original[int(escolha*tamanho)]).split(".")[0]).split(")")[1], melhor[0], "grupos_interpolados/validacao/afasta/" + i)
                ...
                copyfile(atual[0], "grupos_interpolados/validacao/afasta/" + i + "X/" + ficheiro_original)
...
print("ERRADAS - VALIDACAO - AFASTA (DONE!)")
...
if(diferentes>1):
    for i in diretoria:
        if(((i + "X") in diretoria)): continue
        if(("X" not in i) and i[0]!="."):
            print("ERRADAS - VALIDACAO - APROXIMA (" + str(aux) + "/" + str(num_seq) + ")")
            aux += 1

            if(not os.path.exists("grupos_interpolados/validacao/aproxima/" + i + "X")): os.makedirs("grupos_interpolados/validacao/aproxima/" + i + "X")

            ficheiro = open("grupos_interpolados/validacao/aproxima/" + i + "X/1escolha.txt","w")
            ...
            # obter o melhor indivíduo para trocar patches
            if(int(escolha*tamanho)>=tamanho):
                melhor = melhor_individuo(((dir_original[tamanho-1]).split(".")[0]).split(")")[1],"grupos_interpolados/validacao/aproxima/",i)
            
            else:
                melhor = melhor_individuo(((dir_original[int(escolha*tamanho)]).split(".")[0]).split(")")[1],"grupos_interpolados/validacao/aproxima/",i)

            # erro ao tentar obter o melhor indivíduo para trocar patches
            if(melhor[0]=="ERRO"):
                rmtree("grupos_interpolados/validacao/aproxima/" + i + "X")
                continue
            ...
            for count in range(0,num_erradas,1):
                ...
                if(int(escolha*tamanho)>=tamanho):
                    atual = patches(escolhidas, ((dir_original[tamanho-1]).split(".")[0]).split(")")[1], melhor[0], "grupos_interpolados/validacao/aproxima/" + i)
                
                else:
                    atual = patches(escolhidas, ((dir_original[int(escolha*tamanho)]).split(".")[0]).split(")")[1], melhor[0], "grupos_interpolados/validacao/aproxima/" + i)
                ...
                copyfile(atual[0], "grupos_interpolados/validacao/aproxima/" + i + "X/" + ficheiro_original)
...
print("ERRADAS - VALIDACAO - APROXIMA (DONE!)")
...
if(diferentes>1):
    for i in diretoria:
        if(((i + "X") in diretoria)): continue
        if(("X" not in i) and i[0]!="."):
            print("ERRADAS - VALIDACAO - LATERAL (" + str(aux) + "/" + str(num_seq) + ")")
            aux += 1

            if(not os.path.exists("grupos_interpolados/validacao/lateral/" + i + "X")): os.makedirs("grupos_interpolados/validacao/lateral/" + i + "X")

            ficheiro = open("grupos_interpolados/validacao/lateral/" + i + "X/1escolha.txt","w")
            ...
            # obter o melhor indivíduo para trocar patches
            if(int(escolha*tamanho)>=tamanho):
                melhor = melhor_individuo(((dir_original[tamanho-1]).split(".")[0]).split(")")[1],"grupos_interpolados/validacao/lateral/",i)
            
            else:
                melhor = melhor_individuo(((dir_original[int(escolha*tamanho)]).split(".")[0]).split(")")[1],"grupos_interpolados/validacao/lateral/",i)

            # erro ao tentar obter o melhor indivíduo para trocar patches
            if(melhor[0]=="ERRO"):
                rmtree("grupos_interpolados/validacao/lateral/" + i + "X")
                continue
            ...
            for count in range(0,num_erradas,1):
                ...
                if(int(escolha*tamanho)>=tamanho):
                    atual = patches(escolhidas, ((dir_original[tamanho-1]).split(".")[0]).split(")")[1], melhor[0], "grupos_interpolados/validacao/lateral/" + i)
                
                else:
                    atual = patches(escolhidas, ((dir_original[int(escolha*tamanho)]).split(".")[0]).split(")")[1], melhor[0], "grupos_interpolados/validacao/lateral/" + i)
                ...
                copyfile(atual[0], "grupos_interpolados/validacao/lateral/" + i + "X/" + ficheiro_original)
...
print("ERRADAS - VALIDACAO - LATERAL (DONE!)")
print("ERRADAS - VALIDACAO (DONE!)")