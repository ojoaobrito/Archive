    ...
    for i in diretoria:
        ...
        if(("X" not in i) and i[0]!="."):
            ...
            for count in range(0,num_erradas,1):
                ...
                dir_escolhida = os.listdir("grupos_interpolados/teste/afasta/" + dir_escolhida_aux)
                if(int(escolha*len(dir_escolhida))>=len(dir_escolhida)):
                    copyfile("grupos_interpolados/teste/afasta/" + dir_escolhida_aux + "/" + dir_escolhida[len(dir_escolhida)-1], "grupos_interpolados/teste/afasta/" + i + "X/" + ficheiro_original)        

                else:
                    copyfile("grupos_interpolados/teste/afasta/" + dir_escolhida_aux + "/" + dir_escolhida[int(escolha*len(dir_escolhida))], "grupos_interpolados/teste/afasta/" + i + "X/" + ficheiro_original)          
...
if(diferentes>1):
    for i in diretoria:
        ...
        if(("X" not in i) and i[0]!="."):
            ...
            aux += 1
            if(not os.path.exists("grupos_interpolados/teste/aproxima/" + i + "X")): os.makedirs("grupos_interpolados/teste/aproxima/" + i + "X")
            ...
            for count in range(0,num_erradas,1):
                ...
                # mover a patch escolhida para a diretoria "X" com o nome do ficheiro original
                dir_escolhida = os.listdir("grupos_interpolados/teste/aproxima/" + dir_escolhida_aux)
                if(int(escolha*len(dir_escolhida))>=len(dir_escolhida)):
                    copyfile("grupos_interpolados/teste/aproxima/" + dir_escolhida_aux + "/" + dir_escolhida[len(dir_escolhida)-1], "grupos_interpolados/teste/aproxima/" + i + "X/" + ficheiro_original)        

                else:
                    copyfile("grupos_interpolados/teste/aproxima/" + dir_escolhida_aux + "/" + dir_escolhida[int(escolha*len(dir_escolhida))], "grupos_interpolados/teste/aproxima/" + i + "X/" + ficheiro_original)         
    ...
    for i in diretoria:
        ...
        if(("X" not in i) and i[0]!="."):
            ...
            for count in range(0,num_erradas,1):
                ...
                # mover a patch escolhida para a diretoria "X" com o nome do ficheiro original
                dir_escolhida = os.listdir("grupos_interpolados/teste/lateral/" + dir_escolhida_aux)
                if(int(escolha*len(dir_escolhida))>=len(dir_escolhida)):
                    copyfile("grupos_interpolados/teste/lateral/" + dir_escolhida_aux + "/" + dir_escolhida[len(dir_escolhida)-1], "grupos_interpolados/teste/lateral/" + i + "X/" + ficheiro_original)        

                else:
                    copyfile("grupos_interpolados/teste/lateral/" + dir_escolhida_aux + "/" + dir_escolhida[int(escolha*len(dir_escolhida))], "grupos_interpolados/teste/lateral/" + i + "X/" + ficheiro_original)            
