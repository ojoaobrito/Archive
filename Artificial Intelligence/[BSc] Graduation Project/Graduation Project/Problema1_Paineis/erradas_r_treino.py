    ...
    for i in diretoria:
        ...
        if(("X" not in i) and i[0]!="."):
            ...
            for count in range(0,num_erradas,1):
                ...
                dir_escolhida = os.listdir("grupos_interpolados/treino/afasta/" + dir_escolhida_aux)
                if(int(escolha*len(dir_escolhida))>=len(dir_escolhida)):
                    copyfile("grupos_interpolados/treino/afasta/" + dir_escolhida_aux + "/" + dir_escolhida[len(dir_escolhida)-1], "grupos_interpolados/treino/afasta/" + i + "X/" + ficheiro_original)        

                else:
                    copyfile("grupos_interpolados/treino/afasta/" + dir_escolhida_aux + "/" + dir_escolhida[int(escolha*len(dir_escolhida))], "grupos_interpolados/treino/afasta/" + i + "X/" + ficheiro_original)          
    ...
    for i in diretoria:
        ...
        if(("X" not in i) and i[0]!="."):
            ...
            for count in range(0,num_erradas,1):
                ...
                # mover a patch escolhida para a diretoria "X" com o nome do ficheiro original
                dir_escolhida = os.listdir("grupos_interpolados/treino/aproxima/" + dir_escolhida_aux)
                if(int(escolha*len(dir_escolhida))>=len(dir_escolhida)):
                    copyfile("grupos_interpolados/treino/aproxima/" + dir_escolhida_aux + "/" + dir_escolhida[len(dir_escolhida)-1], "grupos_interpolados/treino/aproxima/" + i + "X/" + ficheiro_original)        

                else:
                    copyfile("grupos_interpolados/treino/aproxima/" + dir_escolhida_aux + "/" + dir_escolhida[int(escolha*len(dir_escolhida))], "grupos_interpolados/treino/aproxima/" + i + "X/" + ficheiro_original)           
    ...
    for i in diretoria:
        ...
        if(("X" not in i) and i[0]!="."):
            ...
            for count in range(0,num_erradas,1):
                ...
                # mover a patch escolhida para a diretoria "X" com o nome do ficheiro original
                dir_escolhida = os.listdir("grupos_interpolados/treino/lateral/" + dir_escolhida_aux)
                if(int(escolha*len(dir_escolhida))>=len(dir_escolhida)):
                    copyfile("grupos_interpolados/treino/lateral/" + dir_escolhida_aux + "/" + dir_escolhida[len(dir_escolhida)-1], "grupos_interpolados/treino/lateral/" + i + "X/" + ficheiro_original)        

                else:
                    copyfile("grupos_interpolados/treino/lateral/" + dir_escolhida_aux + "/" + dir_escolhida[int(escolha*len(dir_escolhida))], "grupos_interpolados/treino/lateral/" + i + "X/" + ficheiro_original)           
